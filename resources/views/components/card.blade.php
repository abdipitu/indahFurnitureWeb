@props(['img', 'name', 'price', 'category'])

<div class="w-64 bg-white border shadow hover:shadow-lg hover:shadow-primary flex justify-center">
    <div class="p-2">
        ...
        <div class="px-5">
            ...
            <div class="flex justify-end">
                <div class="py-2 px-4 w-12 rounded-full bg-primary my-5 jus">
