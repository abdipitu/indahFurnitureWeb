    ...
    <form action="/tambah" method="post">
        ...
        <div class="flex gap-5 flex-col font-semibold">
            <div class="flex flex-col">
                ...
                <input type="text" id="nama" name="nama" class="text-black rounded-md border-primary font-medium">
            </div>
            <div class="flex flex-col">
                <label for="keteranganproduk" class="text-black">Keterangan</label>
                <textarea type="text" id="keterangan" name="keterangan" class="text-black rounded-md border-primary font-medium"></textarea>
            </div>
            <div class="flex gap-5">
                <div class="flex flex-col">
                    <label for="kategory" class="text-black">Kategori</label>
                    <input type="text" id="kategori" name="kategori" class="text-black rounded-md border-primary font-medium">
                </div>
                <div class="flex flex-col">
                    <label for="harga" class="text-black">Harga</label>
                    <input type="number" id="harga" name="harga" class="text-black rounded-md border-primary font-medium">
                </div>
                <div class="flex flex-col">
                    <label for="jumlah" class="text-black">Jumlah</label>
                    <input type="text" id="jumlah" name="jumlah" class="text-black rounded-md border-primary font-medium">
                </div>
            </div>
