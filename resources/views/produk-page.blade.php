            ...
            <div class="grid grid-cols-4 justify-evenly mb-10">
                @foreach ($produk as $item)
                    <a href="/deskripsiproduk/{{ $item->id }}">
                        <div
                            class="w-64 bg-white border shadow hover:shadow-lg hover:shadow-primary flex justify-center mb-5">
                            <div class="p-2">
                                <img src="{{ asset('storage/' . $item->image_path) }}" alt="furniture"
                                    class="mb-2 h-56 mt-2 w-56 object-cover">
                                <div class="px-5">
